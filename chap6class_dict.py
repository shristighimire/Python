# -*- coding: utf-8 -*-
"""Chap6CLass_dict.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AngEzWl4w-2F7DgQm1xPbS0q2Dc5xeCC
...
native_language = {'john': ['english','french'], 'juan':'spanish','sue':['english','italian','spanish']}
...
fav_languages = {'jen': 'python','sarah': 'c','edward':[ 'ruby','python'],'phil': 'python'}
...
fav_languages = {'jen': 'python','sarah': ['c', 'python','fortran'],'edward': 'cobol','phil': 'python'}
for name, y in fav_languages.items():
	if type(y) == list:
		for z in range(len(y)):
			print(f'This person:{name} speaks {y[z]}')
	else:
		print(f'This person:{name} speaks {y}')

fav_languages = {'jen': 'python','sarah': ['c', 'python','fortran'],'edward': 'cobol','phil': 'python'}
for name, y in fav_languages.items():
  if type(y) == list:
    while y:
      print(f'This person:{name} speaks {y.pop(0)}')
...
for name, y in fav_languages.items():
	if type(y) == list:
		while y != []:
			print(f'This person:{name} speaks {y[0]}')
      y.pop(0)
	else:
		print(f'This person:{name} speaks {y}')
...
fav_languages = {'jen':['python','cobol'],'sarah':[ 'c','fortran'],'edward': 'python','phil': 'python'}
x=len(fav_languages )
print(x)
...
x=sorted(fav_languages.items())
print(x)
print(x[0])
print(type(x))
print(type(x[0]))
fav_languages=dict(x)
...
print(x)
y= list(x.values())
print(f'{y[0]} is {y[1]} years old and lives in {y[2]}')
...
"""When all values are not in the list"""
...
for name, y in fav_languages.items():
  if type(y) == list:
    print(f'{name.title()} speaks:')
    for z in range(len(y)):
      print(f'\t{y[z]}')
  else:
    print(f'{name.title()} speaks only {y}')
