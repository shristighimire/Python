...
Original file is located at
    https://colab.research.google.com/drive/1cj-eGtecaQmh1dMQGPn-T69NkTbxxdSL
...
class Car:
	...
	def __init__(self, make, model, color): #def is initializing the class, self is the instance, "make, model, color are parameters"
