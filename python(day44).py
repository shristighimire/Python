...
Original file is located at
    https://colab.research.google.com/drive/1ap_MctQVJiV6RKBfGuzy4cieMM3bIvqD
...
class Car:
	...
	def __init__(self, make, model, color):
		...
		self.make = make   # attriutes are self.whatever
		self.model = model
		self.color = color

"""### Create an object from a class:"""

my_car = Car('ford', 'mustang', 'red')  #my_car is an instance
print(my_car)
print(my_car.make)

shristi_car = Car('Tesla','Y','black') # tesla,y,black are parameters
print(f"My favourite car is {shristi_car.make}.")
print(f"My favourite model is {shristi_car.model}.")
print(f"I like it {shristi_car.color}.")

class Animal:
    """A simple animal with three parameters."""

    def __init__(self, legs, color, typee, temperment):
...
shristi_animal = Animal('4','Black','chiuwawa','happy') # shristi_animal is the instance here
print(f"My favourite animal is {shristi_animal.typee}.")
print(f"It is {shristi_animal.color} in color.")
print(f"I has {shristi_animal.legs} legs and is a very {shristi_animal.temperment} dog.")
...
### The function **randint()** returns randomly selected integers between (and including) two numbers
"""

from random import randint
randint(2, 12)

"""The function **choice()** takes in a list or tuple and returns a randomly chosen element."""
